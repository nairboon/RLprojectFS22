...
exp_name = "t7_unstable"

agent_1_lbl = "Q(none)"
agent_2_lbl = "Q(relu)"
agent_3_lbl = "Q(sigmoid)"

agents = [agent_1_lbl,agent_2_lbl, agent_3_lbl]
...
def eval_algos(gamma, eta, beta=0.00005):
    ...
    qlearnerAgent2 = QLearnerAgent(optimizer='sgd', method="q-learning", activation="relu",
                                  initialization=initialization, gamma=gamma,
                                  eta=eta, epsilon_0=epsilon_0, beta=beta, N_h=N_h, name=agent_2_lbl)

    qlearnerAgent3 = QLearnerAgent(optimizer='sgd', method="q-learning", activation="sigmoid",
                                  initialization=initialization, gamma=gamma,
                                  eta=eta, epsilon_0=epsilon_0, beta=beta, N_h=N_h, name=agent_3_lbl)

    arena = Arena(agents=[qlearnerAgent, qlearnerAgent2, qlearnerAgent3], early_stop=True)
